...
public class FavoritosBO implements IFavoritosBO {
    ...
    /**
     * Constructor de la clase FavoritosBO.
     * Inicializa el objeto de acceso a datos para favoritos.
     */
    public FavoritosBO() {
     ...
     * @param favorito El objeto FavoritoDTO que representa el favorito que se desea agregar.
     ...
     * @return El objeto FavoritoDTO que representa el favorito consultado, o null si no se encuentra.
     */
    @Override
     ...
     * @param usuario El nombre de usuario.
     * @return Una lista de objetos FavoritoDTO que representan los favoritos del usuario.
     */
    @Override
     ...
     * @param favorito El objeto FavoritoDTO que representa el favorito que se desea eliminar.
