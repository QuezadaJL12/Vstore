...
public interface IUsuariosBO {
     ...
     * @param usuario El objeto UsuarioDTO que representa el usuario que se desea agregar.
     */
    public void agregarUsuario(UsuarioDTO usuario);

    /**
     * Método para consultar un usuario.
     * @param usuario El objeto UsuarioDTO que representa el usuario que se desea consultar.
     * @return El objeto UsuarioDTO del usuario consultado, o null si no se encuentra.
     */
