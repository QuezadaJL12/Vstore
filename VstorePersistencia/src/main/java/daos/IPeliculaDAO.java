...
public interface IPeliculaDAO {
     ...
     * @return Una lista de objetos Pelicula que representan todas las películas en la base de datos.
     */
     ...
     * @return Una lista de objetos Pelicula que coinciden con el nombre especificado.
     */
     ...
     * @return El objeto Pelicula que coincide con el nombre especificado, o null si no se encuentra.
     */
     ...
     * @return Una lista de objetos Pelicula que pertenecen al género especificado.
     */
